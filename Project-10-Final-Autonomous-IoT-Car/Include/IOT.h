...
unsigned int network_found;

unsigned int process_command;
unsigned int display_action;
...
unsigned int show_adc;

unsigned int time_period;
unsigned int number_of_arrived;
unsigned int ping_time_val;
unsigned int timecheck;

char first_ip_buffer[11];
char second_ip_buffer[11];
