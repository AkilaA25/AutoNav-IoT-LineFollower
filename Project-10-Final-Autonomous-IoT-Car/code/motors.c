...
void match_speed_turn_right(void){
    ...
    if(current_right_wheel_speed < right_wheel_speed) {
      ...
      LEFT_REVERSE_SPEED = current_right_wheel_speed;
    }
    ...
    if(current_left_wheel_speed < left_wheel_speed) {
      ...
      RIGHT_FORWARD_SPEED = current_left_wheel_speed;
    }
}
...
void match_speed_turn_left(void){
    ...
    if(current_right_wheel_speed < right_wheel_speed) {
      ...
      LEFT_FORWARD_SPEED = current_right_wheel_speed;
    }
    ...
    if(current_left_wheel_speed < left_wheel_speed) {
      ...
      RIGHT_REVERSE_SPEED = current_left_wheel_speed;
    }
}
