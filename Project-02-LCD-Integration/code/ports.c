...
void Init_Port_6(void){ //configure port 6
    ...
    P6OUT &= ~R_FORWARD;          // Set R_FORWARD Off [Low]
    ...
    P6OUT &= ~L_FORWARD;          // Set L_FORWARD Off [Low]
    ...
    P6OUT &= ~R_REVERSE;          // Set SPI_CS_LCD Off [Low]
    ...
    P6OUT &= ~L_REVERSE;          // Set SPI_CS_LCD Off [Low]
